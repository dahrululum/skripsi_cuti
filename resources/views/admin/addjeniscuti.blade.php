    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Add jenis cuti</b></div>
                <form action="{{url('admin/post-addjeniscuti')}}" method="POST" id="regForm" class="form-horizontal">
                <div class="card-body">
                   {{ csrf_field() }}
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                    <input class="form-control form-control-sm " id="kd_jenis_cuti" type="text" name="kd_jenis_cuti" value="{{ $nourut }}"  readonly/>
                       
                    </div> 
                  </div>
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label" for="judul">Nama jenis cuti</label>
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm " id="nm_jenis_cuti" type="text" name="nm_jenis_cuti" placeholder="nama jenis cuti" />
