    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Add golongan</b></div>
                <form action="{{url('admin/post-addgolongan')}}" method="POST" id="regForm" class="form-horizontal">
                <div class="card-body">
                   {{ csrf_field() }}
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                    <input class="form-control form-control-sm " id="kd_golongan" type="text" name="kd_golongan" value="{{ $nourut }}"  readonly/>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm " id="nm_golongan" type="text" name="nm_golongan" placeholder="nama golongan" />
