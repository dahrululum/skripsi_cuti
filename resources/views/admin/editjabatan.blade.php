    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Edit jabatan</b></div>
                <form action="{{url('admin/post-editjabatan')}}" method="POST" id="regForm" class="form-horizontal">
                <div class="card-body">
                   {{ csrf_field() }}
                    
                   <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for="judul">Kode jabatan</label>
                    <div class="col-sm-2">
                    <input class="form-control form-control-sm " id="kd_jabatan" type="text" name="kd_jabatan" value="{{ $un->kd_jabatan }}"  readonly/>
                       
                    </div> 
                  </div>
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label" for="judul">Nama jabatan</label>
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm " id="nm_jabatan" type="text" name="nm_jabatan" value="{{ $un->nm_jabatan }} " />
