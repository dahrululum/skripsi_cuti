    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Edit golongan</b></div>
                <form action="{{url('admin/post-editgolongan')}}" method="POST" id="regForm" class="form-horizontal">
                <div class="card-body">
                   {{ csrf_field() }}
                    
                   <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for="judul">Kode golongan</label>
                    <div class="col-sm-2">
                    <input class="form-control form-control-sm " id="kd_golongan" type="text" name="kd_golongan" value="{{ $un->kd_golongan }}"  readonly/>
                       
                    </div> 
                  </div>
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label" for="judul">Nama golongan</label>
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm " id="nm_golongan" type="text" name="nm_golongan" value="{{ $un->nm_golongan }} " />
