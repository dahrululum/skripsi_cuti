    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Add Unitkerja</b></div>
                ...
                <div class="card-body">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                    <input class="form-control form-control-sm " id="kd_unitkerja" type="text" name="kd_unitkerja" value="{{ $nourut }}"  readonly/>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm " id="nm_unitkerja" type="text" name="nm_unitkerja" placeholder="nama unitkerja" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control form-control-sm ket"></textarea>
