    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header"><b>Edit jeniscuti</b></div>
                <form action="{{url('admin/post-editjeniscuti')}}" method="POST" id="regForm" class="form-horizontal">
                <div class="card-body">
                   {{ csrf_field() }}
                    
                   <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for="judul">Kode jenis cuti</label>
                    <div class="col-sm-2">
                    <input class="form-control form-control-sm " id="kd_jenis_cuti" type="text" name="kd_jenis_cuti" value="{{ $un->kd_jenis_cuti }}"  readonly/>
                       
                    </div> 
                  </div>
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label" for="judul">Nama jeniscuti</label>
                      <div class="col-sm-9">
                      <input class="form-control form-control-sm " id="nm_jenis_cuti" type="text" name="nm_jenis_cuti" value="{{ $un->nm_jenis_cuti }} " />
